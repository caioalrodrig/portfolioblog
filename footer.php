...
<nav class="row footer-menu">
    ...
    <div class="column col-md-3 footer-wrapper text-center" >
        ...
        <p style="margin-bottom: 0 !important; margin-left: 10%;">Quisque lobortis dui tortor, pulvinar gravida dolor cursus vel. Quisque condimentum commodo ipsum, vitae tincidunt nisl commodo eget.</p>
